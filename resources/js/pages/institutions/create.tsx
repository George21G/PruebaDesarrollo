...
const breadcrumbs = [
    ...
    { title: 'Crear Entidad', href: '/institutions/create' },
];
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                        ...
                        <div className="flex items-center space-x-4">
                            ...
                            <div>
                                <h1 className="text-3xl font-bold text-white mb-1">Crear Entidad</h1>
                                <p className="text-gray-400">
                                    Agrega una nueva entidad educativa o biblioteca al sistema
                                </p>
                            </div>
                        </div>
                    </div>
